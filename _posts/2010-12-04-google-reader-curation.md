...
{% include JB/setup %}
     ...
     <img src="http://kinlane-productions.s3.amazonaws.com/google_reader_rss_icons.jpg"  width="300" align="right" />It is time to curate my Google Reader subscriptions again. I try to keep my daily blog reading as efficient as possible. To do this I change up my Google Reader in three different ways:
</p>
<ol class="mainlist">
     <li>
