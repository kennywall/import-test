...
---
{% include JB/setup %}<p>Over the next few days google will be rolling out the ability to upload any file type to Google Documents List API for all accounts.
...
With the ability to pay for unlimited storage, ability to upload any file types, and the Google Docs Listing API, Google is now definitely a major player in the cloud storage game.</p>
