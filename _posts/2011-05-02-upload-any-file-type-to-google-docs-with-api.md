...
<img class="c1" src="http://kinlane-productions.s3.amazonaws.com/google/google-docs-upload-any-file-type.png" alt="" width="300" align="right" />Over the next few days google will be rolling out the [ability to upload any file type to Google Documents List API][1] for all accounts.
...
With the ability to pay for unlimited storage, ability to upload any file types, and the Google Docs Listing API, Google is now definitely a major player in the cloud storage game.
   ...
   [1]: http://googleappsdeveloper.blogspot.com/2011/05/upload-all-file-types-to-any-google.html (ability to upload any file type to Google Documents List API)
