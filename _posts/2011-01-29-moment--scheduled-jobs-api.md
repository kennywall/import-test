...
I run most of my web applications on a Windows 2008 server, this is the platform I'm most familiar with. So I use the task scheduler built into the platform. [<img class="c1" src="http://kinlane-productions.s3.amazonaws.com/moment-jobs-api.png" alt="" align="right" />][1] When I migrate applications off my native development environment I need a better way to trigger scheduled jobs.

I found [Moment][1], a Software as a Service (SaaS) for scheduling jobs. They provide a simple [RESTful API for scheduling HTTP based jobs][1] you need to run.

I tend to just create my jobs as simple [PHP][2] scripts and expose them at a non-indexed public URL. So Moment is a great solution.

Its good to see useful utility APIs that everyone can use, doing one thing, and doing it well!

   [1]: http://momentapp.com/
   [2]: http://www.kinlane.com/category/php/
