...
{% include JB/setup %}
     ...
     I review how a lot of events are managed to keep an eye out for best practices. One of the most valuable things an event can do is to video tape each one of its sessions. I'm sure this can be a fairly costly endeavor, but is money well spent.<img title="Google I/O" src="http://code.google.com/events/images/io2010logo.png"  width="250" align="right" />
</p>
