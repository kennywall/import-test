...
So I am always advocating a [simple tool or web application][1] that is easy for users to understand and use.
...
It is appropriately called [Single Function][1].

   [1]: http://singlefunction.com/showcase/
