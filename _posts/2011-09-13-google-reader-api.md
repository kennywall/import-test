...
I'm excited to finally see a <a title="potential API for Google Reader" href="http://code.google.com/p/google-reader-api/">potential API for Google Reader</a>, and the possibility that they are not going to abandon one of my favorite tools.</p>
