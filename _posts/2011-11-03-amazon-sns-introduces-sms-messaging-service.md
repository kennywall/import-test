...
This new Amazon SNS feature can be accessed from the <a title="AWS Management Console" href="http://console.aws.amazon.com">AWS Management Console</a>. SMS notification support is currently supported in the US-East region, and will be available in other AWS regions and countries in the coming months.</p>
