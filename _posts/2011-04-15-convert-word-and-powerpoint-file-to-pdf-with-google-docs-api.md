...
<p>
     If it is a .doc file, it will convert to:<img src="http://kinlane-productions.s3.amazonaws.com/word-to-pdf-conversion.gif"  width="200" align="right" />
</p>
<ul class="mainlist">
     <li>.pdf
     </li>
...
<p>
     If it is a .ppt file, it will convert to:<img src="http://kinlane-productions.s3.amazonaws.com/powerpoint-to-pdf.png"  width="150" align="right" />
</p>
<ul class="mainlist">
     <li>.pdf
     </li>
