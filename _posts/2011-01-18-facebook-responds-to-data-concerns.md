...
---
{% include JB/setup %}<p>
     Last week Facebook expanded the information available to external websites and applications to include profile address and mobile number. <img class="c1"
        src="http://kinlane-productions.s3.amazonaws.com/facebook_logo-icon.png"
        alt=""
        width="250"
        align="right" /> Ummm....Not Cool. Today they responded with:
</p>
