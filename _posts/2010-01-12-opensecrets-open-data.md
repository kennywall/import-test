...
image: 
---
{% include JB/setup %}I love data. When I find great sources of data I have to record it. Here is RAW and API data from the Federal Government. <strong><a href="http://www.opensecrets.org/action/data.php">OpenSecrets Open Data</a></strong> It has:
<ul class="mainlist">
...
</ul>Good stuff. I will start working through this data.