...
</ul>This will allow your print file manager to OAuth with Box.net. Now you need the actual code that lets you pull the file being passed by Box.net and print uses Mimeo.com. Here is a sample code file for doing this: <script src="https://gist.github.com/950096.js?file=Box.net%20-%20Mimeo%20Connect%20Print%20File%20Manager" type="text/javascript">
