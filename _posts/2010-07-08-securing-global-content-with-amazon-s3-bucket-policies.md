...
<img class="alignnone c1" title="Secure Global Content Delivery" src="http://kinlane-productions.s3.amazonaws.com/cloud-computing/global-digital_delivery.jpg" alt="" width="275" align="right" />I'm spending a lot of time lately looking at more efficient and secure ways of delivery web applications and content globally. I am refining my DNS strategy using [Global Server Load Balancing][1] (GSLB), and refining my file and [content management policies now that Amazon Web Services is offering Bucket Policies][2].

**Geographic Specific Sub-Domains (CNAME)**

With [Global Server Load Balancing][3] I can setup geographically specific sub-domains like eu.domain.com and us-west.domain.com that are bound to specific Amazon S3 buckets and [Amazon Cloudfront Distributions][4].

**Secure Files and Content with Bucket Policies**

Now with [Amazon Bucket Policies][2] I can restrict access to buckets for reading or writing to specific domain names, IP Addresses, or IP Ranges.
...
You can really get granular about [where your data is distributed and what geographic regions can access your data][5].

   [1]: http://www.kinlane.com/2010/07/cloud-balancing-with-global-server-load-balancer-gslb/
   [2]: http://www.kinlane.com/2010/07/amazon-web-services-releases-more-granular-access-policies-for-amazon-s3-buckets/
   [3]: http://www.kinlane.com/category/global-server-load-balancing/
   [4]: http://www.kinlane.com/category/amazon/amazon-cloudfront/
   [5]: http://www.kinlane.com/2010/06/do-you-know-where-your-data-is-in-the-cloud/
