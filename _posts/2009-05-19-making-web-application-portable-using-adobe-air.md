...
image: 
---
{% include JB/setup %}I am enjoying taking a current web application and making it run in Adobe Air. So far I have quickly ported an existing ColdFusion web application over to run within a downloadable Adobe Air application.
