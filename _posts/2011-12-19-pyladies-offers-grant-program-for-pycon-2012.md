...
---
{% include JB/setup %}<p>PyLadies, an organization that works to bring women to the forefront of the open source world is now offering a grant program for women in the Python community.
...
Applications for the PyLadies grant program run through January 31, 2012, with notification of awards by February 7. You can get more information about both PyLadiesand PyCon financial aid applications are available.</p>
