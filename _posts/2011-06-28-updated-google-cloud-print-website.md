...
[<img class="c1" src="http://kinlane-productions.s3.amazonaws.com/mimeo/mimeo_connect_logo.jpg" alt="" width="200" align="right" />][1]Google updated the [Google Cloud Print website][2] today with all new documentation, code samples and other goodies to help get up and running using Google Cloud Print.
...
The new [Google Cloud Print][3] site provides two main areas for integration with the Google Cloud Print Services:
...
The new Google Cloud Print update provides much more complete documentation on [submitting print jobs][4] and the [XMPP integration][5] for print job notification.

They also provide [python code samples][6] for integrating with GCP. You can also use the [Mimeo PHP Google Cloud Print samples][7] that I wrote earlier this year, and I will be working on a set of C# samples also, and publish when ready.

   [1]: http://developer.mimeo.com (Mimeo-Google Cloud Print)
   [2]: http://code.google.com/apis/cloudprint/docs/overview.html (Google Cloud Print website)
   [3]: http://developer.mimeo.com/blog/blog_detail.php?ID=143 (Google Cloud Print)
   [4]: http://code.google.com/apis/cloudprint/docs/sendJobs.html (submitting print jobs)
   [5]: http://code.google.com/apis/cloudprint/docs/rawxmpp.html (XMPP integration)
   [6]: http://code.google.com/apis/cloudprint/docs/sendJobs.html (Google Cloud Print Python Code Samples)
   [7]: https://github.com/mimeoconnect/Google-Cloud-Print-Proxy (Mimeo PHP Gogole Cloud Print Samples)
