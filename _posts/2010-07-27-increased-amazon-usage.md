...
{% include JB/setup %}<p>
     <img class="alignnone c1"
        ...
        alt=""
        width="250"
        align="right" />Once again I'm pushing the limits of what I"m allowed within an Amazon Web Services account. I need more server instances and more reserved IP addresses. So I have to go to the form(s) Amazon provides to:
</p>

<ul class="mainlist">
     <li>
          <a href="http://aws.amazon.com/contact-us/ec2-request/"
              target="_blank">Request to Increase Amazon EC2 Instance Limit</a>
     </li>

     <li>
          <a href="http://aws.amazon.com/contact-us/eip_limit_request/"
              target="_blank">Request to Increase Elastic IP Address Limit</a>
     </li>
</ul>
