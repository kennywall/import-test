...
[<img class="c1" src="http://kinlane-productions.s3.amazonaws.com/github-logo.png" alt="" align="right" />][1]I'm still working on the deployment of the Mimeo Connect Cloud Print API area. In the mean time I am preparing a lot of content to publish when its ready.
...
I've started using [github][2] for all the code libraries used in my API Area.
