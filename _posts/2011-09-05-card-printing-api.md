...
---
{% include JB/setup %}<p>Weve added a newAPI that provides card printing services for developers.It enables you to price and order commercially printed cards in different sizes, paper and coating from within your web and mobile applications.These are the different settings currently available for cards:

	size- 4.25×5.5, 5×7, 5.</p>
