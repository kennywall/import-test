...
I've talked about the [My Mimeo online print and publishing][1], and the [My Mimeo Marketplace][2] where you can publish documents for people to purchase. Now I feel I can actually introduce you to the [Mimeo Connect Print API][3], now that you have an overview of Mimeo.
...
I will be spending more time playing with the API over the coming weeks and providing more specific samples of how to build rich web and social applications that take advantage of the REST Print API.
   ...
   [2]: http://www.kinlane.com/2010/10/my-mimeo-marketplace-creating-a-online-print-store/
   [3]: http://www.mimeo.com/solutions/mimeo-connect.php
