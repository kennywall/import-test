...
I don't see any evidence of an API, which would allow for syndication and potential print on demand publishing for [building real-time crowd-sourced newspapers and magazines][2] ,but I will keep monitoring ViewsHound in the future.

   [1]: http://www.viewshound.com/ (ViewsHound)
   [2]: http://developer.mimeo.com/blog/blog_detail.php?ID=158 (real-time crowd-sourced newspapers and magazines)
