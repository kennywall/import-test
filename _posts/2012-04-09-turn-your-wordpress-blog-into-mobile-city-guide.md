...
---
{% include JB/setup %}<p>I'm always on the lookout for tools that CityGrid publishers can use alongside the web and mobile apps they've built using CityGrid Places and Advertising APIs.
...
Article Source Credit&nbsp;-&nbsp;Introducing Placeling: Turn Your Blog Into an iPhone-based City Guide</p>
