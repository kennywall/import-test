...
</ul>This will allow your bound document printer to OAuth with Box.net. Now you need the actual code that lets you pull the file being passed by Box.net and print uses Mimeo.com. Here is a sample code file for doing this: <script src="https://gist.github.com/950054.js?file=Box.net%20-%20Mimeo%20Connect%20Bound%20Document%20Printer" type="text/javascript">
