...
Today they released a Beta version of [Google Cloud Print that runs inChrome for MacOS][1] 10.5 and above.
...
So you can print any HTML, PDF, or any page you are viewing in the Chrome browser running on the Mac to your printer registered with Google Cloud Print.
   ...
   [1]: http://www.google.com/chrome/intl/en/p/cloudprint.html (Google Cloud Print That Runs in Chrome for Mac)
