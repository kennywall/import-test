...
---
{% include JB/setup %}
<img src="http://kinlane-productions.s3.amazonaws.com/cloud-storage/Box-logo-new.jpg"  width="200" align="right" />
...
</ul>An important part of this application is a callback URL for when users first add the Box.net application.This has to be a page you host that handles the Box.net oAuth, which gives this single sheet printer access to a users account.
...
<img src="http://kinlane-productions.s3.amazonaws.com/Box.net/Open-Box.png"  width="250" align="right" />
<ul class="blue">
...
</ul>This will allow your single sheet printer to OAuth with Box.net.
