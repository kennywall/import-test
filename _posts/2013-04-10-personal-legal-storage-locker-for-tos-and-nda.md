...
I’m unpacking all my notes from my time spent at the MIT Media Lab this last weekend.  One of the byproducts of hanging out with so many smart people is I end up with all kind of great ideas, and I know better than to think I can do them all myself, so I [put my ideas out on the web][1] for anyone to run with.

My project from theHackathon this weekend was [#ReclaimYourDomain][2], which I’ll write about in detail separately, but the overall project objective was to educate people about:
...
This is something I would like to have integrated into our vision of [#ReclaimYourDomain][2], but for now it would be awesome if someone would get to work building a central storage system, complete with API, desktop clients and browser plugins. :-)
...
If we are going to start empowering people to take control of their worlds, the legal layer to all of this will be essential.
   ...
   [1]: /blog/tag.php?Search_Tag=ideas
   [2]: http://reclaimyourdomain.org
