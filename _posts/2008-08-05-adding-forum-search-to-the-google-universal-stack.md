...
{% include JB/setup %}
     ...
     <br />
     <br />
     Then I jump over to use <a href="http://www.boardtracker.com/">BoardTracker</a> and <a href="http://boardreader.com/">BoardReader</a> to search through forums on different topics.
     <br />
     <br />
