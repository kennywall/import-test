...
---
{% include JB/setup %}<p>I was just talking about using Amazon for backing up your data in the clouds. One feature that Amazon introduced recently was version control for Amazon S3 data.
