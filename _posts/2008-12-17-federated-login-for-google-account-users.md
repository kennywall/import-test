...
It is really slick I recommend checking out the <a href="Google Checkout - Prototype (Developer)">Google Federated Login informatio</a>n as well as reading up on the <a href="http://openid.net/">OpenID Standard</a>.</p>
