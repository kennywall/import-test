...
<p>
     I use automated tools to backup data from my:<img class="alignnone c1" title="Zmanda" src="http://kinlane-productions.s3.amazonaws.com/cloud-computing/zmanda.png"  width="96" height="81" align="right" />
</p>
<ul class="mainlist">
     <li>
