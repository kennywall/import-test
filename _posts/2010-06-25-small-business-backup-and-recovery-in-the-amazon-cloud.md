...
---
{% include JB/setup %}
Many businesses are growing into the clouds, but there are still are many on the fence. Before a business moves their entire small business setup to the Amazon cloud, they might consider using Amazon S3 just for backup and recovery.
