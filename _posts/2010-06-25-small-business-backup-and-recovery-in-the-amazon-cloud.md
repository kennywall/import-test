...
{% include JB/setup %}<p>
     <img class="alignnone c1"
        title="Jungle Disk"
        src="http://kinlane-productions.s3.amazonaws.com/cloud-computing/jungle-disk-logo.gif"
        alt=""
        width="242"
        height="42"
...
<ul class="mainlist">
     ...
     <li>
          <strong><a href="https://www.jungledisk.com/"
             target="_blank">Jungle Disk</a></strong>
     </li>
</ul>

<p>
     I use automated tools to backup data from my:<img class="alignnone c1"
        title="Zmanda"
        src="http://kinlane-productions.s3.amazonaws.com/cloud-computing/zmanda.png"
        alt=""
        width="96"
        height="81"
        align="right" />
