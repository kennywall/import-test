...
---
{% include JB/setup %}<p>Foursquare just&nbsp;took another step with local recommendations&nbsp;by launching a new web version of&nbsp;Foursquare Explore.
...
Foursquare Explore shows the local check-in has definitely come of age.</p>
